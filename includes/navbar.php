...
<nav class="navigation-container">
    ...
    <div class="opciones">
        ...
        <h3 class="direeciones"><a class="desktop-nav-header" href="<?php echo SITE_URL; ?>source/parques.php">PARQUES</a></h3>
        <h3 class="direeciones"><a class="desktop-nav-header" href="<?php echo SITE_URL; ?>source/servicios.php">SERVICIOS</a></h3>
        <h3 class="direeciones"><a class="desktop-nav-header" href="<?php echo SITE_URL; ?>source/contacto.php">CONTACTO</a></h3>
        <div class=" media">
